...
<?php
		$q1=mysql_query("select * from questions where tag = 'SQL'");
		$n=1;
	...
	<div class="ques container-fluid">
		...
		<?php
		$heading=$ar[0];
		$q3=mysql_query("select * from answers where tag='SQL' and id='".$ar[0]."'");
		...
		<div class="row content">
			...
			<button type='submit' name='topi' class='btn btn-info pull-right'>
				&nbsp;&nbsp;<a href="answer(sql).php?id=<?php echo $ar[0]?>" style="text-decoration: none;">Answer</a>&nbsp;&nbsp;	
			</button>
			</form>
		</div>
	</div>
