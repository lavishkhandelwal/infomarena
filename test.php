...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <td>&nbsp;</td>
	...
	?>
	<a href="test.php?id=<?php echo $a[0]?>"><?php echo $a[1]?></a>&nbsp;&nbsp;::&nbsp;&nbsp;
	<?php
	$id1=$_GET['id'];
	$q1=mysql_query("select * from ques where id='".$id1."'");
 ...
 <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="2" width="500">
        <tr>
          <td class="pageName"><?php echo $a1[1]?></td>
        </tr>
        <tr>
          <td class="bodyText"><p><?php echo $a1[2]?></p></td>
		</tr>
      </table>
	</td>
    <td width="100%">&nbsp;</td>
