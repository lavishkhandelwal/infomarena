...
<body>
	...
	<div class="container-fluid top">
		<div class="row">
			...
			<div class="col-sm-2">
				<img src="images/rail.png" class="img-responsive" />
			</div>	
			<div class="col-sm-6">
				<h1>RAILS</h1>
	...
	<?php
		$q1=mysql_query("select * from questions where tag = 'Rails'");
		$n=1;
	...
	<div class="ques container-fluid">
		...
		<?php
		$heading=$ar[0];
		$q3=mysql_query("select * from answers where tag='Rails' and id='".$ar[0]."'");
		...
		<div class="row content">
			...
			<button type='submit' name='topi' class='btn btn-info pull-right'>
				&nbsp;&nbsp;<a href="answer(rails).php?id=<?php echo $ar[0]?>" style="text-decoration: none;">Answer</a>&nbsp;&nbsp;	
			</button>
			</form>
		</div>
	</div>
